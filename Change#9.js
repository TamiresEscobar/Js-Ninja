...
/* anotação
    calculator vai receber dois numeros como parametros
    que vai retornar uma função de callback como parametro
    callback é uma função que precisa ser invocada
    o retoorno desse callback retorna num1 e num2 passados por
    parametro
*/
...
/* anotação
guardamos na variavel sum os parametros de num1 e num2
*/
...
/* anotação
para retornar a função de calculator é necessário criar essa função de callback
isso ocorre pq foi definido que o calculator receberia a função de callback como parametro

logo a variavel sum está recebendo uma função callback que retorna uma função que soma number1 e number2
*/
