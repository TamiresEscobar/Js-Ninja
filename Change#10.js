...
*/
// antes var five = '5'  abaixo converte string 5 para number 5 console retorno true

var five = Number('5')
console.log( five + ' é número?', typeof five === 'number' );

// antes var concat = 10 + 10
...
function calculator(operator){
    !isOperatorValid(operator) && false

    return function( x, y){
        typeof x !== 'number' || typeof y !== 'number' && false
